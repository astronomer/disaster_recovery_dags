...
# from include.assign_tokens_to_backups import sync_tokens_to_backups
#
# default_args = {
#     "owner": "airflow",
#     "retries": 3,
...
#     )
#
#     # sync_tokens_task = PythonOperator(
#     #     task_id="sync_tokens_to_backup_workspaces",
#     #     python_callable=sync_tokens_to_backups,
#     # )
#
...
#     # get_deployments_task >> create_backup_workspaces_task >> create_backup_deployments_task >> unhibernate_backup_deployments_task >> sync_tokens_task